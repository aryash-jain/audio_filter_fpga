...
static int test_passthrough() {
    ...
    enable_t en = 0b000;
    audio_pipeline(in, out, en, (gain_t)1.0, (sample_t)0, (sample_t)0, (fixed_t)0);
...
static int test_volume_only() {
    ...
    /* half gain */
    audio_pipeline(in, out, en, (gain_t)0.5, (sample_t)0, (sample_t)0, (fixed_t)0);
    for (int i = 0; i < SAMPLE_SIZE; i++) {
    ...
    /* clipping at 2× */
    int e2 = 0;
    audio_pipeline(in, out, en, (gain_t)2.0, (sample_t)0, (sample_t)0, (fixed_t)0);
    for (int i = 0; i < SAMPLE_SIZE; i++) {
...
static int test_echo_only() {
    ...
    audio_pipeline(in, out, en, (gain_t)1.0, (sample_t)4, (sample_t)0.5, (fixed_t)0);
    ...
    audio_pipeline(in, out, en, (gain_t)1.0, (sample_t)50, (sample_t)0.0, (fixed_t)0);
    for (int i = 0; i < SAMPLE_SIZE; i++) {
...
static int test_pitch_only() {
    ...
    audio_pipeline(in, out, en, (gain_t)1.0, (sample_t)0, (sample_t)0, (fixed_t)0.0);
    ...
    // octave up
    gen_sine(in, f_in, 8000);
    audio_pipeline(in, out, en, (gain_t)1.0, (sample_t)0, (sample_t)0, (fixed_t)12.0);
    find_peak_freq(out, FS, &f_out);
