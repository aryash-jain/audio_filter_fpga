namespace eval ::optrace {
  variable script "E:/audio/audio.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/audio/audio.cache/wt [current_project]
  set_property parent.project_path E:/audio/audio.xpr [current_project]
  set_property ip_repo_paths E:/audio_filter_fpga-main [current_project]
  update_ip_catalog
  set_property ip_output_repo E:/audio/audio.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/audio/audio.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/audio/audio.srcs/sources_1/bd/design_1/design_1.bd
